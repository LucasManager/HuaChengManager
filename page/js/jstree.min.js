        ...
        c.setAttribute("role", "treeitem"), l = o.createElement("I"), l.className = "jstree-icon jstree-ocl", c.appendChild(l), l = o.createElement("A"), l.className = "jstree-anchor", l.setAttribute("href", "#"), h = o.createElement("I"), h.className = "jstree-icon jstree-themeicon", l.appendChild(h), c.appendChild(l), l = h = null, e.jstree = {version: "3.0.4", defaults: {plugins: []}, plugins: {}, path: d && -1 !== d.indexOf("/") ? d.replace(/\/[^\/]+$/, "") : "", idregex: /[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%]/g}, e.jstree.create = function (t, s) {
            ...
            return function (i) {
                    ...
                    if (i.status && ("#" !== i.node.id || this._data.core.loaded || (this._data.core.loaded = !0, this.trigger("loaded")), !this._data.core.ready && !this.get_container_ul().find(".jstree-loading:eq(0)").length)) {
                        if (this._data.core.ready = !0, this._data.core.selected.length) {
                            if (this.settings.core.expand_selected_onload) {
                                var s = [], r, n;
                                for (r = 0, n = this._data.core.selected.length; n > r; r++)
                                    s = s.concat(this._model.data[this._data.core.selected[r]].parents);
                                for (s = e.vakata.array_unique(s), r = 0, n = s.length; n > r; r++)
                ...
                if (e = e.parents ? e : this.get_node(e), !e || "#" === e.id || !e.parents)
                    return!1;
                var s, r, n = [];
                for (n.push(i?e.id:e.text), s = 0, r = e.parents.length; r > s; s++)
                ...
                if (null !== s) {
                    ...
                    while (t.hasClass("jstree-open"))
                        t = t.children(".jstree-children:eq(0)").children(".jstree-node:visible:last");
                    return t
                }
                ...
                for (a = 0, d = e.length; d > a; a++)
                    !n[e[a]] || n[e[a]].state.loaded && i || (this.is_loading(e[a]) || this.load_node(e[a], r), s = !1);
                ...
                var n = null, a = {df: this._model.default_state, dat: i, par: t.id, m: this._model.data, t_id: this._id, t_cnt: this._cnt, sel: this._data.core.selected}, d = function (e, t) {
                    ...
                    var i = e.dat, s = e.par, r = [], n = [], a = [], d = e.df, o = e.t_id, c = e.t_cnt, l = e.m, h = l[s], _ = e.sel, u, g, f, p, m = function (e, i, s) {
                        ...
                        for (e && e.children && e.children === !0 && (_.state.loaded = !1, _.children = [], _.children_d = []), l[_.id] = _, n = 0, o = _.children.length; o > n; n++)
                            c = m(l[_.children[n]], _.id, s), h = l[c], _.children_d.push(c), h.children_d.length && (_.children_d = _.children_d.concat(h.children_d));
                        ...
                        if (e && e.children && e.children.length) {
                            for (n = 0, h = e.children.length; h > n; n++)
                                _ = v(e.children[n], g.id, s), u = l[_], g.children.push(_), u.children_d.length && (g.children_d = g.children_d.concat(u.children_d));
                    ...
                    if (i.length && i[0].id !== t && i[0].parent !== t) {
                        ...
                        for (g = 0, f = h.children.length; f > g; g++)
                            u = m(l[h.children[g]], s, h.parents.concat()), n.push(u), l[u].children_d.length && (n = n.concat(l[u].children_d));
                        ...
                        for (g = 0, f = i.length; f > g; g++)
                            u = v(i[g], s, h.parents.concat()), u && (r.push(u), n.push(u), l[u].children_d.length && (n = n.concat(l[u].children_d)));
                        for (h.children = r, h.children_d = n, g = 0, f = h.parents.length; f > g; g++)
                            l[h.parents[g]].children_d = l[h.parents[g]].children_d.concat(n);
                        p = {cnt: c, mod: l, sel: _, par: s, dpc: n, add: a}
                    }
                    return p
                ...
                for (e && e.children && e.children === !0 && (h.state.loaded = !1, h.children = [], h.children_d = []), n[h.id] = h, d = 0, o = h.children.length; o > d; d++)
                    c = this._parse_model_from_flat_json(n[h.children[d]], h.id, s), l = n[c], h.children_d.push(c), l.children_d.length && (h.children_d = h.children_d.concat(l.children_d));
                ...
                if (e && e.children && e.children.length) {
                    for (n = 0, a = e.children.length; a > n; n++)
                        d = this._parse_model_from_json(e.children[n], h.id, s), o = c[d], h.children.push(d), o.children_d.length && (h.children_d = h.children_d.concat(o.children_d));
                ...
                for (s = 0, r = e.length; r > s; s++)
                    i = this.redraw_node(e[s], !0, this._model.force_full_redraw), i && this._model.force_full_redraw && t.appendChild(i);
                ...
                if (i = i || 0 === r.children.length, t = document.querySelector ? this.element[0].querySelector("#" + (-1 !== "0123456789".indexOf(r.id[0]) ? "\\3" + r.id[0] + " " + r.id.substr(1).replace(e.jstree.idregex, "\\$&") : r.id.replace(e.jstree.idregex, "\\$&"))) : document.getElementById(r.id))
                    t = e(t), s || (n = t.parent().parent()[0], n === this.element[0] && (n = null), a = t.index()), i || !r.children.length || t.children(".jstree-children").length || (i = !0), i || (d = t.children(".jstree-children")[0]), p = t.attr("aria-selected"), f = t.children(".jstree-anchor")[0] === document.activeElement, t.remove();
                else if (i = !0, !s) {
                    if (n = "#" !== r.parent ? e("#" + r.parent.replace(e.jstree.idregex, "\\$&"), this.element)[0] : null, !(null === n || n && g[r.parent].state.opened))
                        return!1;
                ...
                if (_.length && (t.childNodes[1].className = "jstree-anchor " + _), (r.icon && r.icon !== !0 || r.icon === !1) && (r.icon === !1 ? t.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden" : -1 === r.icon.indexOf("/") && -1 === r.icon.indexOf(".") ? t.childNodes[1].childNodes[0].className += " " + r.icon + " jstree-themeicon-custom" : (t.childNodes[1].childNodes[0].style.backgroundImage = "url(" + r.icon + ")", t.childNodes[1].childNodes[0].style.backgroundPosition = "center center", t.childNodes[1].childNodes[0].style.backgroundSize = "auto", t.childNodes[1].childNodes[0].className += " jstree-themeicon-custom")), this.settings.core.force_text ? t.childNodes[1].appendChild(u.createTextNode(r.text)) : t.childNodes[1].innerHTML += r.text, i && r.children.length && r.state.opened && r.state.loaded) {
                    for (h = u.createElement("UL"), h.setAttribute("role", "group"), h.className = "jstree-children", o = 0, l = r.children.length; l > o; o++)
                ...
                if (this.is_loaded(i))
                    ...
                    })) : (this.trigger("before_open", {node: i}), d[0].className = d[0].className.replace("jstree-closed", "jstree-open"), d[0].setAttribute("aria-expanded", !0))), i.state.opened = !0, s && s.call(this, i, !0), d.length || this.trigger("before_open", {node: i}), this.trigger("open_node", {node: i}), r && d.length || this.trigger("after_open", {node: i});
                else {
                ...
                var s, r;
                if (e.isArray(i)) {
                    for (i = i.slice(), s = 0, r = i.length; r > s; s++)
                ...
                if (!s.length) {
                    for (r = 0, n = e.children_d.length; n > r; r++)
                ...
                if (this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && (!i.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent))
                    if (i.shiftKey) {
                        ...
                        for (d = 0, o = n.length; o > d; d += 1)
                            n[d] === s && (a = !a), n[d] === r && (a = !a), a || n[d] === s || n[d] === r ? this.select_node(n[d], !1, !1, i) : this.deselect_node(n[d], !1, i)
                    } else
                ...
                for (this._data.core.selected = this._model.data["#"].children_d.concat(), i = 0, s = this._data.core.selected.length; s > i; i++)
                ...
                var t = this._data.core.selected.concat([]), i, s;
                for (i = 0, s = this._data.core.selected.length; s > i; i++)
                ...
                for (r = 0, n = i.length; n > r; r++)
                    s[i[r].id] = i[r];
                for (r = 0, n = i.length; n > r; r++)
                    for (a = 0, d = i[r].children_d.length; d > a; a++)
                ...
                if (i) {
                    if (i.core) {
                        var r, n, a, d;
                        if (i.core.open)
                            return e.isArray(i.core.open) ? (r = !0, n = !1, a = this, e.each(i.core.open.concat([]), function (t, d) {
                        ...
                        if (i.core.scroll)
                            return i.core.scroll && i.core.scroll.left !== t && this.element.scrollLeft(i.core.scroll.left), i.core.scroll && i.core.scroll.top !== t && this.element.scrollTop(i.core.scroll.top), delete i.core.scroll, this.set_state(i, s), !1;
                        if (i.core.selected)
                        ...
                        if (e.isEmptyObject(i.core))
                            return delete i.core, this.set_state(i, s), !1
                    }
                ...
                for (i = "" + i, n[t.parent].children[e.inArray(t.id, n[t.parent].children)] = i, s = 0, r = t.parents.length; r > s; s++)
                    n[t.parents[s]].children_d[e.inArray(t.id, n[t.parents[s]].children_d)] = i;
                for (s = 0, r = t.children.length; r > s; s++)
                ...
                var s, r;
                if (e.isArray(t)) {
                    for (t = t.slice(), s = 0, r = t.length; r > s; s++)
                        this.set_text(t[s], i);
                    return!0
                }
                ...
                if (t && t.no_id && (delete s.id, s.li_attr && s.li_attr.id && delete s.li_attr.id), t && t.flat && "#" !== e.id && i.push(s), !t || !t.no_children)
                    for (r = 0, n = e.children.length; n > r; r++)
                ...
                if (r > i.children.length && (r = i.children.length), s.id || (s.id = !0), !this.check("create_node", s, i, r))
                    return this.settings.core.error.call(this, this._data.core.last_error), !1;
                if (s.id === !0 && delete s.id, s = this._parse_model_from_json(s, i.id, i.parents.concat()), !s)
                    return!1;
                for (d = this.get_node(s), o = [], o.push(s), o = o.concat(d.children_d), this.trigger("model", {nodes:o, parent:i.id}), i.children_d = i.children_d.concat(o), c = 0, l = i.parents.length; l > c; c++)
                    this._model.data[i.parents[c]].children_d = this._model.data[i.parents[c]].children_d.concat(o);
                for (s = d, d = [], c = 0, l = i.children.length; l > c; c++)
                ...
                if (e.isArray(t)) {
                    for (t = t.slice(), i = 0, s = t.length; s > i; i++)
                        this.delete_node(t[i]);
                    return!0
                }
                if (t = this.get_node(t), !t || "#" === t.id)
                    return!1;
                if (r = this.get_node(t.parent), n = e.inArray(t.id, r.children), h = !1, !this.check("delete_node", t, r, n))
                    return this.settings.core.error.call(this, this._data.core.last_error), !1;
                ...
                for (this.trigger("delete_node", {node:t, parent:r.id}), h && this.trigger("changed", {action:"delete_node", node:t, selected:this._data.core.selected, parent:r.id}), c = 0, l = a.length; l > c; c++)
                ...
                if (s = this.get_node(s), r = r === t ? 0 : r, !s)
                    return!1;
                ...
                if (e.isArray(i)) {
                    for (i = i.reverse().slice(), d = 0, o = i.length; o > d; d++)
                        this.move_node(i[d], s, r, n, a);
                    return!0
                }
                if (i = i && i.id ? i : this.get_node(i), !i || "#" === i.id)
                    return!1;
                if (c = "" + (i.parent || "#"), h = ("" + r).match(/^(before|after)$/) && "#" !== s.id ? this.get_node(s.parent) : s, _ = i.instance ? i.instance : this._model.data[i.id] ? this : e.jstree.reference(i.id), u = !_ || !_._id || this._id !== _._id, l = _ && _._id && c && _._model.data[c] && _._model.data[c].children ? e.inArray(i.id, _._model.data[c].children) : -1, u)
                    return this.copy_node(i, s, r, n, a) ? (_ && _.delete_node(i), !0) : !1;
                ...
                if (r > h.children.length && (r = h.children.length), !this.check("move_node", i, h, r, {core: !0, is_multi: _ && _._id && _._id !== this._id, is_foreign: !_ || !_._id}))
                    return this.settings.core.error.call(this, this._data.core.last_error), !1;
                if (i.parent === h.id) {
                    for (g = h.children.concat(), f = e.inArray(i.id, g), - 1 !== f && (g = e.vakata.array_remove(g, f), r > f && r--), f = [], p = 0, m = g.length; m > p; p++)
                        f[p >= r ? p + 1 : p] = g[p];
                    ...
                    for (f = i.children_d.concat(), f.push(i.id), p = 0, m = i.parents.length; m > p; p++) {
                        for (g = [], k = _._model.data[i.parents[p]].children_d, v = 0, j = k.length; j > v; v++)
                            -1 === e.inArray(k[v], f) && g.push(k[v]);
                        _._model.data[i.parents[p]].children_d = g
                    }
                    for (_._model.data[c].children = e.vakata.array_remove_item(_._model.data[c].children, i.id), p = 0, m = h.parents.length; m > p; p++)
                        this._model.data[h.parents[p]].children_d = this._model.data[h.parents[p]].children_d.concat(f);
                    for (g = [], p = 0, m = h.children.length; m > p; p++)
                        g[p >= r ? p + 1 : p] = h.children[p];
                    for (g[r] = i.id, h.children = g, h.children_d.push(i.id), h.children_d = h.children_d.concat(i.children_d), i.parent = h.id, f = h.parents.concat(), f.unshift(h.id), k = i.parents.length, i.parents = f, f = f.concat(), p = 0, m = i.children_d.length; m > p; p++)
                        this._model.data[i.children_d[p]].parents = this._model.data[i.children_d[p]].parents.slice(0, -1 * k), Array.prototype.push.apply(this._model.data[i.children_d[p]].parents, f);
                ...
                if (r > f.children.length && (r = f.children.length), !this.check("copy_node", i, f, r, {core: !0, is_multi: p && p._id && p._id !== this._id, is_foreign: !p || !p._id}))
                    return this.settings.core.error.call(this, this._data.core.last_error), !1;
                ...
                if (u.id === !0 && delete u.id, u = this._parse_model_from_json(u, f.id, f.parents.concat()), !u)
                    return!1;
                for (l = this.get_node(u), i && i.state && i.state.loaded === !1 && (l.state.loaded = !1), c = [], c.push(u), c = c.concat(l.children_d), this.trigger("model", {nodes:c, parent:f.id}), h = 0, _ = f.parents.length; _ > h; h++)
                    this._model.data[f.parents[h]].children_d = this._model.data[f.parents[h]].children_d.concat(c);
                for (c = [], h = 0, _ = f.children.length; _ > h; h++)
            ...
            this.bind = function () {
                ...
                s.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", e.proxy(function () {
                    ...
                    for (n = 0, a = r.length; a > n; n++)
                        i[r[n]].state.checked = i[r[n]].original && i[r[n]].original.state && i[r[n]].original.state.checked, i[r[n]].state.checked && this._data.checkbox.selected.push(r[n])
                        ...
                        if (r.state[g ? "selected" : "checked"]) {
                            ...
                            for (o = 0, c = n.length; c > o; o++)
                                if (s[n[o]].state[g ? "selected" : "checked"]) {
                                    for (l = 0, h = s[n[o]].children_d.length; h > l; l++)
                    ...
                    if (-1 !== h.indexOf("down"))
                        for (this._data[_?"core":"checkbox"].selected = e.vakata.array_unique(this._data[_?"core":"checkbox"].selected.concat(s.children_d)), d = 0, o = s.children_d.length; o > d; d++)
                            l = r[s.children_d[d]], l.state[_ ? "selected" : "checked"] = !0, l && l.original && l.original.state && l.original.state.undetermined && (l.original.state.undetermined = !1);
                    if (-1 !== h.indexOf("up"))
                        while (n && "#" !== n.id) {
                    ...
                    for (r = 0, n = i.children_d.length; n > r; r++)
                        a = s[i.children_d[r]], a && a.original && a.original.state && a.original.state.undetermined && (a.original.state.undetermined = !1)
                    ...
                    if (s && s.original && s.original.state && s.original.state.undetermined && (s.original.state.undetermined = !1), -1 !== o.indexOf("down"))
                        for (n = 0, a = s.children_d.length; a > n; n++)
                            d = this._model.data[s.children_d[n]], d.state[c ? "selected" : "checked"] = !1, d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1);
                    if (-1 !== o.indexOf("up"))
                        for (n = 0, a = s.parents.length; a > n; n++)
                            d = this._model.data[s.parents[n]], d.state[c ? "selected" : "checked"] = !1, d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1), d = this.get_node(s.parents[n], !0), d && d.length && d.children(".jstree-anchor").removeClass(c ? "jstree-clicked" : "jstree-checked");
                    ...
                    while (i && "#" !== i.id) {
                        for (a = 0, r = 0, n = i.children.length; n > r; r++)
                    ...
                    while (d && "#" !== d.id) {
                        for (o = 0, c = 0, l = d.children.length; l > c; c++)
                            o += a[d.children[c]].state[_ ? "selected" : "checked"];
                        if (o === l)
                            d.state[_ ? "selected" : "checked"] || (d.state[_ ? "selected" : "checked"] = !0, this._data[_ ? "core" : "checkbox"].selected.push(d.id), h = this.get_node(d, !0), h && h.length && h.children(".jstree-anchor").addClass(_ ? "jstree-clicked" : "jstree-checked"));
                        else {
                ...
                for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function () {
                    ...
                    if (e.state.loaded)
                        for (t = 0, i = e.children_d.length; i > t; t++)
                            r = s[e.children_d[t]], !r.state.loaded && r.original && r.original.state && r.original.state.undetermined && r.original.state.undetermined === !0 && (a.push(r.id), a = a.concat(r.parents));
                    else
                    ...
                    s[a[t]].state[r ? "selected" : "checked"] || (n = this.get_node(a[t], !0), n && n.length && n.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined"))
            ...
            e(document).on("dnd_start.vakata.jstree", function (e, t) {
                        ...
                        if (n.attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")), d.helper.children().attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")).find(".jstree-copy:eq(0)")[d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "show" : "hide"](), d.event.target !== o.element[0] && d.event.target !== o.get_container_ul()[0] || 0 !== o.get_container_ul().children().length) {
                            ...
                            for (v = !0, j = 0, k = d.data.nodes.length; k > j; j++)
                                if (v = v && o.check(d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "copy_node" : "move_node", d.data.origin && d.data.origin !== o ? d.data.origin.get_node(d.data.nodes[j]) : d.data.nodes[j], "#", "last", {dnd: !0, ref: o.get_node("#"), pos: "i", is_multi: d.data.origin && d.data.origin !== o, is_foreign: !d.data.origin}), !v)
                                    break;
                            if (v)
                                return i = {ins: o, par: "#", pos: "last"}, n.hide(), d.helper.find(".jstree-icon:eq(0)").removeClass("jstree-er").addClass("jstree-ok"), t
                        }
                ...
                if (r && clearTimeout(r), a && a.data && a.data.jstree) {
                    ...
                    if (i) {
                        ...
                        d = e(a.event.target).closest(".jstree"), d.length && s && s.error && "check" === s.error && (d = d.jstree(!0), d && d.settings.core.error.call(this, s))
                }
            ...
            e.vakata.search = function (e, t, i) {
                ...
                return a > 32 && (i.fuzzy = !1), i.fuzzy && (d = 1 << a - 1, o = function () {
                    ...
                    for (-1 !== u && (_ = Math.min(c(0, u), _), u = t.lastIndexOf(e, s + a), -1 !== u && (_ = Math.min(c(0, u), _))), u = -1, r = 0; a > r; r++) {
                        g = 0, f = p;
                        while (f > g)
                            _ >= c(r, s + f) ? g = f : p = f, f = Math.floor((p - g) / 2 + g);
        ...
        e.jstree.defaults.state = {key: "jstree", events: "changed.jstree open_node.jstree close_node.jstree", ttl: !1, filter: !1}, e.jstree.plugins.state = function (t, i) {
            ...
            this.init = function (e, i) {
                ...
                this.element.on("model.jstree", e.proxy(function (e, i) {
                    ...
                    for (a = 0, d = r.length; d > a; a++)
                        o = "default", s[r[a]].original && s[r[a]].original.type && n[s[r[a]].original.type] && (o = s[r[a]].original.type), s[r[a]].data && s[r[a]].data.jstree && s[r[a]].data.jstree.type && n[s[r[a]].data.jstree.type] && (o = s[r[a]].data.jstree.type), s[r[a]].type = o, s[r[a]].icon === !0 && n[o].icon !== t && (s[r[a]].icon = n[o].icon);
                    s["#"].type = "#"
                ...
                if (e.isArray(c))
                    for (n = 0, a = c.length; a > n; n++)
                        c[n].type = c[n].id && d[c[n].id] && d[c[n].id].type ? d[c[n].id].type : "default", i && i.no_id && (delete c[n].id, c[n].li_attr && c[n].li_attr.id && delete c[n].li_attr.id);
                else
                    ...
                    case"copy_node":
                        if ("move_node" !== i || -1 === e.inArray(r.id, n.children)) {
                            if (c = this.get_rules(n), c.max_children !== t && -1 !== c.max_children && c.max_children === n.children.length)
                                return this._data.core.last_error = {error: "check", plugin: "types", id: "types_01", reason: "max_children prevents function: " + i, data: JSON.stringify({chk: i, pos: a, obj: r && r.id ? r.id : !1, par: n && n.id ? n.id : !1})}, !1;
                            if (c.valid_children !== t && -1 !== c.valid_children && -1 === e.inArray(r.type, c.valid_children))
                                return this._data.core.last_error = {error: "check", plugin: "types", id: "types_02", reason: "valid_children prevents function: " + i, data: JSON.stringify({chk: i, pos: a, obj: r && r.id ? r.id : !1, par: n && n.id ? n.id : !1})}, !1;
                            if (o && r.children_d && r.parents) {
                                for (l = 0, h = 0, _ = r.children_d.length; _ > h; h++)
                            ...
                            do {
                                if (c.max_depth !== t && -1 !== c.max_depth && l > c.max_depth)
                                    return this._data.core.last_error = {error: "check", plugin: "types", id: "types_03", reason: "max_depth prevents function: " + i, data: JSON.stringify({chk: i, pos: a, obj: r && r.id ? r.id : !1, par: n && n.id ? n.id : !1})}, !1;
            ...
            this.check = function (t, i, r, n, a) {
                ...
                for (h = 0, _ = r.children.length; _ > h; h++)
        ...
        g.setAttribute("unselectable", "on"), g.className = "jstree-wholerow", g.innerHTML = "&#160;", e.jstree.plugins.wholerow = function (t, i) {
            this.bind = function () {
                i.bind.call(this), this.element.on("ready.jstree set_state.jstree", e.proxy(function () {
                    ...
                    this.element.find(".jstree-wholerow-clicked").removeClass("jstree-wholerow-clicked");
                    var i = !1, s, r;
                    for (s = 0, r = t.selected.length; r > s; s++)
                        i = this.get_node(t.selected[s], !0), i && i.length && i.children(".jstree-wholerow").addClass("jstree-wholerow-clicked")
